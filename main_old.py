...
#module for training of ml model
...
# print(f"The root mean squared error for Linear reression is :{lin_rmse}")
...
# print(f"The root mean squared error for Linear reression is :{dec_rmse}")


# random forest Regressor
ran_for_reg = RandomForestRegressor()
ran_for_reg.fit(housing_prepared,housing_labels)
ran_for_predict = ran_for_reg.predict(housing_prepared)
ran_for_rmse = -cross_val_score(ran_for_reg, housing_prepared,housing_labels, scoring="neg_root_mean_squared_error", cv=10)
print(pd.Series(ran_for_rmse).describe())
# ran_for_rmse = root_mean_squared_error(housing_labels,ran_for_predict)
# print(f"The root mean squared error for Linear reression is :{ran_for_rmse}")